...
from .utils import TACT_BASE_DIR, ensure_dir, info, success
...
# Tact launcher — TouchDesigner on Linux
tact_base="${{TACT_BASE_DIR:-${{TD_BASE_DIR:-${{HOME}}/.local/share/tact}}}}"
TD_BASE_DIR="$tact_base"
